          ...
          <div className="flex items-center gap-1 md:gap-2">
            <div className="relative">
              <div className="flex items-center gap-1">
                ...
                {account && (
                  <Button  // Added a copy button (clipboard icon) next to the wallet address in the header
                    size="icon"
                    variant="ghost"
                    className="h-8 w-8 rounded-full"
                    onClick={copyWalletAddress}
                    title={addressCopied ? "Copied!" : "Copy address"} // Copy icon next to address
                  >
                    {addressCopied
            ...
            {error && <span className="hidden text-xs text-destructive lg:inline">{error}</span>}
            <ThemeToggle />
            {session ? (
              <Button 
                size="icon" 
